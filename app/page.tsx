  ...
  if (err) {
    return (
      <div
        ...
        className={`bg-gradient-to-br from-yellow-400 to-[#1e3a8a] rounded-lg flex items-center justify-center ${className}`}
      >
        ...
        {heroSlides.map((_, i) => (
          <button
            ...
            className={`h-2 rounded-full transition-all duration-300 ${
              i === index ? "w-8 bg-gradient-to-r from-[#1e3a8a] to-green-600" : "w-2 bg-gray-300"
            }`}
          />
        ))}
      </div>
...
/* --------------------------- Testimonials Slider --------------------------- */
const testimonials = [
  { name: "Adaeze O.", role: "JAMB Student", text: "iSkolars helped me score 320 in JAMB. The tutors are patient and the mock exams prepared me perfectly.", rating: 5 },
  { name: "Tunde A.", role: "Web Dev Graduate", text: "I went from zero coding experience to landing a junior developer role in 6 months. Incredible program.", rating: 5 },
  { name: "Fatima B.", role: "IELTS Candidate", text: "Scored Band 8 in IELTS thanks to the personalized study plan and native-speaker instructors.", rating: 5 },
  { name: "Chidi N.", role: "Cybersecurity Student", text: "The hands-on labs and real-world projects made cybersecurity concepts click instantly. Highly recommend!", rating: 5 },
];
            ...
            <div key={i} className="min-w-full px-4">
              <Card className="border-0 shadow-xl bg-white/90 backdrop-blur">
                <CardContent className="p-8 text-center">
                  <Quote className="h-10 w-10 text-[#1e3a8a] mx-auto mb-4 opacity-60" />
...
/* ------------------------------- Services Data ----------------------------- */
const services = [
  { icon: BookMarked, title: "Adult Education", desc: "Flexible literacy, numeracy and life-skills programs designed for working adults returning to education.", color: "navy", features: ["Basic literacy & numeracy", "Evening & weekend classes", "Certificate on completion"] },
  { icon: Home, title: "Home Lessons", desc: "One-on-one private tutoring at your home — perfect for focused learners who prefer personalized attention.", color: "green", features: ["Qualified private tutors", "Flexible scheduling", "All subjects & levels"] },
  { icon: Wifi, title: "Online Classes", desc: "Join interactive live classes from anywhere in the world with our virtual learning platform.", color: "navy", features: ["Live & recorded sessions", "Interactive whiteboards", "Global access"] },
  { icon: Presentation, title: "Webinars & Workshops", desc: "Free and premium webinars on trending topics — tech, exam tips, career growth and more.", color: "purple", features: ["Industry expert hosts", "Q&A sessions", "Recorded playbacks"] },
  { icon: Briefcase, title: "Corporate Training", desc: "Upskill your team with customized technology and soft-skills training programs for organizations.", color: "amber", features: ["Tailored curriculum", "On-site or virtual", "Progress reports"] },
  { icon: Heart, title: "Career Counseling", desc: "Guidance on study paths, career choices, and admission processes — from experts who've been there.", color: "pink", features: ["1-on-1 sessions", "University applications", "Career roadmaps"] },
];

const colorMap: Record<string, { bg: string; text: string; border: string }> = {
  navy:    { bg: "bg-[#dbe4f0]", text: "text-[#1e3a8a]", border: "border-[#b8c9e0]" },
  blue:    { bg: "bg-[#dbe4f0]", text: "text-[#1e3a8a]", border: "border-[#b8c9e0]" }, // alias → navy
...
export default function ISkolarsAcademy() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f0f4fa] via-green-50 to-yellow-50 overflow-x-hidden">
      <style jsx global>{`
        @keyframes gradient {
        ...
        .card-hover:hover { transform: translateY(-8px); box-shadow: 0 24px 40px -12px rgba(30,58,138,0.25); }
      ...
      {/* Header */}
      <header className="bg-white/80 backdrop-blur-md border-b border-[#dbe4f0] sticky top-0 z-50 shadow-sm">
            ...
            <nav className="hidden md:flex items-center gap-6 xl:gap-8 ml-auto">
              {["home", "services", "courses", "about", "contact"].map((item) => (
                <a
                  key={item}
                  href={`#${item}`}
                  className="text-gray-700 hover:text-[#1e3a8a] transition-colors relative capitalize text-sm lg:text-base after:absolute after:bottom-[-4px] after:left-0 after:h-[2px] after:w-0 after:bg-gradient-to-r after:from-[#1e3a8a] after:to-green-600 after:transition-all after:duration-300 hover:after:w-full"
                >
                  {item}
                </a>
              ))}
              <Button className="bg-[#1e3a8a] hover:bg-[#15285e] text-white shadow-md hover:shadow-lg transition-all hover:scale-105 ml-2">
                Enroll Now
              </Button>
            </nav>
          </div>
      ...
      <section id="home" className="py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-br from-[#b8c9e0] to-green-200 rounded-full opacity-30 blur-3xl animate-float" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <Reveal className="space-y-8" y={40}>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="bg-[#1e3a8a] hover:bg-[#15285e] text-white shadow-lg hover:shadow-xl transition-all hover:scale-[1.03] group"
                >
                  <Play className="mr-2 h-5 w-5 group-hover:scale-110 transition-transform" />
                  Start Learning
                </Button>

                {/* View Courses — optimized hover */}
                <Button
                  size="lg"
                  variant="outline"
                  className="group border-2 border-[#1e3a8a] text-[#1e3a8a] bg-transparent hover:bg-[#1e3a8a] hover:text-white hover:border-[#1e3a8a] transition-all duration-300 hover:scale-[1.03] hover:shadow-lg"
                >
                  View Courses
              ...
              <div className="flex items-center space-x-8 pt-4">
                {[
                  { to: 500, suffix: "+", label: "Students Trained", color: "text-[#1e3a8a]" },
            ...
            <Reveal className="relative" delay={200} y={60}>
              ...
              <div className="absolute -bottom-4 -left-4 w-72 h-72 bg-gradient-to-br from-[#b8c9e0] to-green-200 rounded-full opacity-30 blur-3xl animate-float-slow" />
            </Reveal>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <Reveal className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Beyond courses, we provide a full suite of educational services tailored to learners of every age and background.
            </p>
          </Reveal>
              ...
              return (
                <Reveal key={s.title} delay={i * 80}>
                  <Card className={`card-hover ${c.border} h-full bg-white`}>
                    <CardHeader>
                      <div className={`w-14 h-14 ${c.bg} rounded-xl flex items-center justify-center mb-4 transition-transform duration-500 group-hover:scale-110`}>
      ...
      {/* Courses Section */}
      <section id="courses" className="py-20 bg-gradient-to-br from-[#f0f4fa]/50 to-green-50/50">
        <div className="container mx-auto px-4">
          <Reveal className="text-center mb-16">
            <Badge className="bg-[#dbe4f0] text-[#1e3a8a] border-[#b8c9e0] mb-4">Our Programs</Badge>
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Comprehensive Learning Pathways</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From exam preparation to professional tech skills — diverse programs designed to launch your academic and career success.
            </p>
          </Reveal>
          ...
          <div className="mb-16">
            <Reveal>
              <h3 className="text-2xl font-bold text-gray-900 mb-8 flex items-center">
                <BookOpen className="mr-3 h-6 w-6 text-[#1e3a8a]" />
                Academic Coaching & Exam Preparation
              </h3>
            </Reveal>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { icon: Globe, title: "Local Exams", desc: "JAMB, WAEC, NECO, Post-UTME", color: "navy", features: ["Comprehensive syllabus coverage", "Mock exams & practice tests", "Expert tutoring"] },
                { icon: Award, title: "International Exams", desc: "IELTS, TOEFL, SAT, GRE, GMAT", color: "green", features: ["Native speaker instructors", "Personalized study plans", "Exam registration assistance"] },
                { icon: Users, title: "Registration Services", desc: "End-to-end exam registration", color: "amber", features: ["Document preparation", "Online registration", "Payment processing"] },
              ].map((c, i) => {
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { icon: Code, title: "Web Development", desc: "Frontend & Backend Development", tags: ["HTML/CSS", "JavaScript", "React", "Node.js"], text: "Build modern, responsive websites and web applications", color: "navy" },
                { icon: Smartphone, title: "App Development", desc: "iOS & Android Development", tags: ["React Native", "Flutter", "Swift", "Kotlin"], text: "Build native and cross-platform mobile applications", color: "navy" },
                ...
                { icon: Monitor, title: "Computer Basics", desc: "Digital Literacy & Office Skills", tags: ["MS Office", "MS Excel", "Internet", "Typing"], text: "Essential computer skills for the modern world", color: "navy" },
              ].map((c, i) => {
                const col = colorMap[c.color];
                const Icon = c.icon;
                return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <Reveal y={40}>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Located in the heart of Ajah, Lagos, iSkolars Academy stands as a beacon of educational excellence, combining traditional academic coaching with cutting-edge technology training.
              </p>
              <div className="space-y-4 mb-8">
                {[
                  { icon: CheckCircle, color: "navy", title: "Expert Instructors", desc: "Certified professionals with years of industry experience" },
                  ...
                  return (
                    <div key={i} className="flex items-start space-x-3 group">
                      <div className={`w-6 h-6 ${col.bg} rounded-full flex items-center justify-center flex-shrink-0 mt-1 group-hover:scale-110 transition-transform`}>
              ...
              <div className="flex items-center space-x-4">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="w-10 h-10 bg-gradient-to-br from-[#1e3a8a] to-green-400 rounded-full border-2 border-white hover:scale-110 transition-transform" />
                  ))}
                </div>
                <div>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 bg-gradient-to-br from-[#0f1d44] via-[#15285e] to-green-800 text-white relative overflow-hidden">
            ...
            <Reveal delay={150} y={40}>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                ...
                <form className="space-y-6">
                  ...
                  <Button className="w-full bg-[#1e3a8a] hover:bg-[#15285e] text-white font-semibold py-3 hover:scale-[1.02] transition-transform shadow-lg border border-white/10">
                    Send Message
                  </Button>
                </form>
              </div>
